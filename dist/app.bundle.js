...
(0, _jquery2.default)('document').ready(function () {
  ...
  (0, _jquery2.default)("a.video-area__button-details, \
    .service__button-details>a").click(function (e) {
    e.preventDefault();
    jivo_api.open({ start: 'call' });
  });
  (0, _jquery2.default)('.button--link-call, .main-footer__button_call, .service__button-call').click(function (e) {
    if (window.matchMedia("(min-width: 667px)").matches && window.matchMedia("(max-width: 1200px)").matches) {
      e.preventDefault();
      jivo_api.open();
      setTimeout(function () {
        (0, _jquery2.default)('#jivo_container').contents().find('jdiv.callMe_BG').click();
      }, 200);
    }
  });
});
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(2), __webpack_require__(14)))
...
*/
var aa=__webpack_require__(6),ba=__webpack_require__(0),m=__webpack_require__(22),p=__webpack_require__(7),v=__webpack_require__(4),da=__webpack_require__(21),ea=__webpack_require__(20),fa=__webpack_require__(19),ha=__webpack_require__(5);
...
var _controlled_input = __webpack_require__(13);

var _controlled_input_discret = __webpack_require__(12);

var _certs_nominal_select = __webpack_require__(11);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    this.state.showNominalInput ? _react2.default.createElement(_controlled_input.ControlledCertificateInput, { minValue: this.config.hardmin, defaultValue: '', callback: this.certNominalChange.bind(this) }) : '',
...
(0, _jquery2.default)('document').ready(function () {
  ...
  (0, _jquery2.default)('.slider').each(function (sliderNum, slider) {
    (0, _jquery2.default)('.slider__item', slider).each(function (itemNum, item) {
      ...
      swipedetect(item, function (swipedir) {
        var curdot = (0, _jquery2.default)(item).parents('.slider__items').siblings('.slider__controls').find('.button-controls.active')[0];
        console.log(curdot);
        if (swipedir === 'right') {
  ...
  (0, _jquery2.default)('.menu a').click(function () {
    (0, _jquery2.default)('.menu--is-open').removeClass('menu--is-open');
    (0, _jquery2.default)('#hamburger').removeClass('hamburger--is-open');
  });
  ...
  trigger.click(function () {
    ...
    (0, _jquery2.default)('.menu').toggleClass('menu--is-open');
    (0, _jquery2.default)('#hamburger').toggleClass('hamburger--is-open');
    if (isClosed == true) {
