...
*/
var aa=__webpack_require__(3),ba=__webpack_require__(1),m=__webpack_require__(11),p=__webpack_require__(2),v=__webpack_require__(5),da=__webpack_require__(12),ea=__webpack_require__(13),fa=__webpack_require__(14),ha=__webpack_require__(4);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(7), __webpack_require__(19)))
...
jquery_default.a.fn.swapWith = function (to) {
  return this.each(function () {
    var copy_to = jquery_default()(to).clone(true);
    var copy_from = jquery_default()(this).clone(true);
    jquery_default()(to).replaceWith(copy_from);
    jquery_default()(this).replaceWith(copy_to);
  });
};
...
jquery_default()('document').ready(function () {
  ...
  // });
  jquery_default()('.slider').each(function (sliderNum, slider) {
    jquery_default()('.slider__item', slider).each(function (itemNum, item) {
      var itemNumS = itemNum;

      swipedetect(item, function (swipedir) {

        if (swipedir === 'right') {
          if (jquery_default()(item).prev().length) {
            jquery_default()(item).prev().removeClass('slider__item--left').addClass('slider__item--right');

            jquery_default()(item).removeClass('slider__item--active');
            jquery_default()(item).prev().addClass('slider__item--active');
          }
        } else if (swipedir === 'left') {
          if (jquery_default()(item).next().length) {
            jquery_default()(item).removeClass('slider__item--right').addClass('slider__item--left');
            jquery_default()(item).removeClass('slider__item--active');
            jquery_default()(item).next().addClass('slider__item--active');
          }
        }
      });
      jquery_default()(item).click(function (e) {
        jquery_default()('.slider__item', slider).removeClass('slider__item--active');
        jquery_default()(item).addClass('slider__item--active');

        if (!itemNum) itemNum = 0;
        let $rightItems = jquery_default()('.slider__item:nth-child(n + ' + itemNum + ')', slider);
        let $leftItems = jquery_default()('.slider__item:nth-child(-n + ' + itemNum + ')', slider);
  ...
  var $supportContact = jquery_default()('#support-contact');
  var $reactForm = jquery_default()('#cert-app-wed');
  // $reactForm.hide();
  // $('body').append($supportContact);

  jquery_default()(document).on('wheel', function (e) {
    if (!doing) {
      doing = true;
  ...
  jquery_default()(document).on('mousewheel', function (e) {
    if (!doing) {
      doing = true;
      _scroll(1);
    } else {
  ...
  jquery_default()(document).on('touchmove', function (e) {
    //touchmove works for iOS, I don't know if Android supports it
    jquery_default()(document).trigger('mousewheel');
  });

  var trigger = jquery_default()('#hamburger'),
  ...
  jquery_default()('.main-header__menu').toggleClass('main-header__menu--hidden');

  var activeclass = 'section__hover';
  var activeclass2 = 'section__hover2';
  var items = jquery_default()('.slider');
  jquery_default()('.section').addClass('off');
  var i = 0;
  var last = jquery_default()('.section').eq(i);
  ...
  jquery_default()('#menu a, #logo, .service__button-buy-sertificate a, .video-area__button-buy-sertificate').click(function (e) {
    if (window.matchMedia("(min-width: 1200px)").matches) {
      e.preventDefault();
    }
    doing = true;
    var dp = jquery_default()(this).attr('data-page');
    i = dp - 1;
    burgerTime();
  });

  function burgerTime() {
    let item = jquery_default()('.section').eq(i);
    let blockleft, blockright;
    if (item.hasClass('section--main')) {
      // правые элементы
      blockleft = jquery_default()('.service__caption, .service__description, .service__note-caption, .service__note, .service__buttons', item);
      // левые элементы
      blockright = jquery_default()('.service__image', item);
    } else {
      // правые элементы
      blockleft = jquery_default()('.service__slider', item);
      // левые элементы
      blockright = jquery_default()('.service__caption, .service__description, .service__note, .service__buttons, .service__image', item);
    }
    ...
    window.setTimeout(function () {
      ...
      jquery_default()('#menu a').removeClass('active');
      jquery_default()("#menu a[data-page='" + (i + 1) + "']").addClass('active');
      // doing = false;
      window.setTimeout(function () {
        doing = false;
      }, 1500);
...
var sweetalert_min = __webpack_require__(17);

// CONCATENATED MODULE: ./src/js/controlled_input.jsx

// import $ from 'jquery';

class controlled_input_ControlledCertificateInput extends react_default.a.Component {
    constructor(props) {
        super(props);
        this.config = {
    ...
    render() {
        return react_default.a.createElement(
            ...
            react_default.a.createElement(
                ...
                react_default.a.createElement('input', { className: 'denomination-custom__value', type: 'text',
                    ref: input => {
...
// CONCATENATED MODULE: ./src/js/controlled_input_discret.jsx


class controlled_input_discret_ControlledInput extends react_default.a.Component {
    constructor() {
        super();
    ...
    render() {
        return react_default.a.createElement(
            ...
            react_default.a.createElement(
                ...
                react_default.a.createElement('input', { type: 'text', className: 'quantity__value', name: this.state.name, value: this.state.value, onChange: this.changeCountEvent.bind(this), onWheel: this.wheel.bind(this) })
            )
        );
    }
}
// CONCATENATED MODULE: ./src/js/certs_nominal_select.jsx

// import $ from 'jquery';
// !!!Stateless component!!!
class certs_nominal_select_CertsNominalSelect extends react_default.a.Component {
    constructor(props) {
        super(props);
        ...
        return react_default.a.createElement(
            ...
            react_default.a.createElement(
                ...
                react_default.a.createElement(
                    ...
                    this.nominals.map(nominalValue => react_default.a.createElement(
                        "option",
...
// CONCATENATED MODULE: ./src/js/cert_app.jsx
...
class cert_app_CertApp extends react_default.a.Component {
    constructor(props) {
        super(props);
        this.config = {
    ...
    dialogue(context) {
        ...
        swal({
            ...
            var result = {
                name: jquery_default()('#swal-input-name').val(),
                contact: jquery_default()('#swal-input-contact').val()
            };
    ...
    addCertToBasket(clickEvent) {
        ...
        return;
        jquery_default.a.ajax(this.config.url, {
            method: 'POST',
    ...
    render() {
        ...
        return react_default.a.createElement(
            ...
            react_default.a.createElement(
                ...
                react_default.a.createElement(certs_nominal_select_CertsNominalSelect, { callback: this.selectedNominal.bind(this), nominal: this.state.nominalMode }),
                this.state.showNominalInput ? react_default.a.createElement(controlled_input_ControlledCertificateInput, { minValue: this.config.hardmin, defaultValue: this.state.nominal, callback: this.certNominalChange.bind(this) }) : '',
                react_default.a.createElement(controlled_input_discret_ControlledInput, { name: '\u041A\u043E\u043B\u043B\u0438\u0447\u0435\u0441\u0442\u0432\u043E', minValue: this.config.hardmin, defaultValue: this.state.count, callback: this.certCountChange.bind(this) }),
                react_default.a.createElement(
                    'button',
...
jquery_default()('document').ready(function () {
    ...
    if (typeof cert_app_CertApp != 'undefined' && document.getElementById('cert-app-wed')) react_dom_default.a.render(react_default.a.createElement(cert_app_CertApp, { nominal: 15000, nominalMode: 15000, certype: WEDDING }), document.getElementById('cert-app-wed'));
});
// EXTERNAL MODULE: ./src/scss/base.scss
var base = __webpack_require__(22);

// EXTERNAL MODULE: ./src/js/cssasync.js
var cssasync = __webpack_require__(20);

// CONCATENATED MODULE: ./src/js/jivo.js
...
jquery_default()('document').ready(function () {
  ...
  jquery_default()(".main-header__support").click(function (e) {
    e.preventDefault();
    jivo_api.open();
  });
  jquery_default()(".service__button-call, video-area__button-details, .service__button-details, .service__button-details>a, .main-footer__button_call").click(function (e) {
    e.preventDefault();
